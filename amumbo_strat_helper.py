...
def check_signals(sp500_data, amumbo_data, vix_data, vix_thresh, sma_period):
    ...
    print("{:34s} {:>10.4f}".format("Latest VIX M75 Week Diff:",round(vix_thresh-latest_vix_m75_7,4)))
    print("{:34s} {:>10.4f}".format("Latest VIX M75 Month Diff:",round(vix_thresh-latest_vix_m75_7,4)))
    print("-"*45)
    print("{:34s} {:>10.4f}".format("Latest S&P 500 Price:",round(latest_sp500_price,4)))
    print("{:34s} {:>10.4f}\n".format("Latest S&P 500 SMA200:",round(latest_sp500_sma200,4)))
    print("{:34s} {:>10.4f}".format("Latest S&P 500 SMA50 Diff:",round(latest_sp500_price-latest_sp500_sma50,4)))
    print("{:34s} {:>10.4f}".format("Latest S&P 500 SMA Quarter Diff:",round(latest_sp500_price-latest_sp500_smaq,4)))
    print("{:34s} {:>10.4f}".format("Latest S&P 500 SMA150 Diff:",round(latest_sp500_price-latest_sp500_sma150,4)))
    print("-"*45)
    print("-"*45)
    print("{:34s} {:>10.4f}".format("Latest Amumbo Price:",round(latest_amumbo_price,4)))
    print("{:34s} {:>10.4f}\n".format("Latest Amumbo SMA200:",round(latest_amumbo_sma200,4)))
    print("{:34s} {:>10.4f}".format("Latest Amumbo SMA50 Diff:",round(latest_amumbo_price-latest_amumbo_sma50,4)))
    print("{:34s} {:>10.4f}".format("Latest Amumbo SMA Quarter Diff:",round(latest_amumbo_price-latest_amumbo_smaq,4)))
